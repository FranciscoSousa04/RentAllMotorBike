...
class DetalhesAluguerTest extends \Codeception\Test\Unit
{
    ...
    public function testDataNull(){
        ...
        $detalhesaluguer->motociclo_id = null;
        $this->assertFalse($detalhesaluguer->validate(['motociclo_id']));
    ...
    public function testNotExistingData(){
        ...
        $detalhesaluguer->motociclo_id = 1001;
        $this->assertFalse($detalhesaluguer->validate(['motociclo_id']));
    ...
    public function testCorrectData()
    {
        ...
        $detalhesaluguer->motociclo_id = 1 ;
        ...
        $this->assertTrue($detalhesaluguer->validate([$detalhesaluguer->motociclo_id]));
    ...
    public function testSavingDetalhesaluguer()
    {
        ...
        $this->tester->seeRecord('common\models\Detalhesaluguer', ['seguro_id' => 1, 'motociclo_id'=>1, 'profile_id'=>3]);

        //update
        $novo = $this->tester->grabRecord('common\models\Detalhesaluguer', ['seguro_id' => 1, 'motociclo_id'=>1, 'profile_id'=>3]);
        $novo->seguro_id = 2;
        $novo->save();
        $this->assertEquals(2, $novo->seguro_id);
        $this->tester->seeRecord('common\models\Detalhesaluguer', ['seguro_id' => 2, 'motociclo_id'=>1, 'profile_id'=>3]);
        $this->tester->dontSeeRecord('common\models\Detalhesaluguer', ['seguro_id' => 1, 'motociclo_id'=>1, 'profile_id'=>3]);

        //delete
        $novo->delete();
        $this->tester->dontSeeRecord('common\models\Detalhesaluguer', ['seguro_id' => 2, 'motociclo_id'=>1, 'profile_id'=>3]);
    }
}
