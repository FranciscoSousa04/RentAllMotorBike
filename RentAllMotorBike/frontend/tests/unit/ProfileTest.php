...
class ProfileTest extends \Codeception\Test\Unit
{
    ...
    public function testDataNull(){
        ...
        $profile->nr_cartaconducao = null;
        $this->assertFalse($profile->validate(['nr_cartaconducao']));
    }
    ...
    public function testLongData(){
        ...
        $profile->nr_cartaconducao = '1234567890123';
        $this->assertFalse($profile->validate(['nr_cartaconducao']));
    }
    ...
    public function testNotUniqueData(){
        ...
        $profile->nr_cartaconducao = '111222333';
        $this->assertFalse($profile->validate(['nr_cartaconducao']));
    }
    ...
    public function testWrongData(){
        ...
        $profile->nr_cartaconducao = 111222399;
        $this->assertFalse($profile->validate(['nr_cartaconducao']));
    ...
    public function testCorrectData()
    {
        ...
        $profile->nr_cartaconducao = '231231256';
        ...
        $this->assertTrue($profile->validate([$profile->nr_cartaconducao]));
    ...
    public function testSavingUser()
    {
        ...
        $profile->nr_cartaconducao = '231231256000' ;
        $profile->save();
