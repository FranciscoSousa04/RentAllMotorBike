        ...
        if ($this->request->isPost) {
           ...
           /* $subquery = Detalhesaluguer::find()
            ...
            $command = $connection->createCommand(
                "select distinct idmotociclo from motociclo 
                    ...
                    left join detalhes_aluguer on detalhes_aluguer.motociclo_id = motociclo.idmotociclo 
                    where tipo_motociclo.categoria like :tipo
                        ...
                        and motociclo.idmotociclo not in (
            ...
            foreach ($result as $key) {
                $carros[] = motociclo::find()->where(['idmotociclo' => $key['idmotociclo']])->one();
            }
