...
<?php $this->beginPage() ?>
    ...
    <header>
            ...
            <div class="row">
                <div class="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="text-body px-3" href="https://www.google.com/"><i class="fa fa-envelope mr-2"></i>rentallmotorbike@gmail.com</a>
                    </div>
                </div>
        ...
        if (Yii::$app->user->isGuest) {
            ...
            $menuItems[] = ['label' => 'Login', 'url' => ['/site/login']];
                ...
                if (array_keys(Yii::$app->authManager->getRolesByUser(Yii::$app->user->getId()))[0] == "cliente") {
                    $menuItems[] = ['label' => 'motociclos', 'url' => ['/motociclo/index']];


                    $profile = \common\models\Profile::find()->where(['id_user' => Yii::$app->user->getId()])->one();
                    $motociclos = \common\models\Detalhesaluguer::find()->where(['profile_id' => $profile->id_profile])->one();
                    $analises = \common\models\Analise::find()->limit(6)->all();
                    //var_dump($motociclos);die;
            ...
            $menuItems[] =
                ...
                [
                    ...
                    'items' => [
                        ['label' => 'Perfil', 'url' => ['profile/view', 'id_user' => Yii::$app->user->getId()]],
        ...
        <div class="container-fluid bg-white pt-3 px-lg-5">
            <div class="row mx-n2">
                <form class="row" action=" <?= \yii\helpers\Url::toRoute(['motociclo/index']) ?> " method="post">
                    <input type="hidden" name="_csrf-frontend" value="<?= Yii::$app->request->getCsrfToken(); ?>">
                    <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                        <h2>rentallmotorbike</h2>
                    </div>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                        <select class="custom-select px-4 mb-3" style="height: 50px;" name="tipomotociclo">
                            <option selected="selected">Selecione o tipo</option>
                            <?php
                            // A sample product array
                            $products = ArrayHelper::map(Tipomotociclo::find()->all(), 'tipo_motociclo_id', 'categoria');
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                        <button class="btn btn-primary btn-block mb-3" name="btnProcurarmotociclo" type="submit"
                                style="height: 50px;">Procurar
                        </button>
                    </div>
                </form>
            </div>
        ...
        <footer class="footer mt-auto py-3 text-muted">
            ...
            <div class="container-fluid bg-secondary py-5 px-sm-3 px-md-5" style="margin-top: 90px;">
                <div class="row pt-5">
                    <div class="col-lg-3 col-md-6 mb-5">
                        ...
                        <p><i class="fa fa-envelope text-white mr-3"></i>rentallmotorbike@gmail.com</p>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="container-fluid bg-dark py-4 px-sm-3 px-md-5">
                <p class="mb-2 text-center text-body">&copy; <a href="#">rentallmotorbike</a>. All Rights Reserved.</p>
